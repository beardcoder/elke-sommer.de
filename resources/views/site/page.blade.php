...
<body>
  <div class="space-y-12">
    <header class="p-4">
      <div class="container mx-auto flex h-16 justify-between">
        <a rel="noopener noreferrer" href="#" aria-label="Back to homepage" class="flex items-center p-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="h-8 w-8">
            <path
        ...
        <ul class="hidden items-stretch space-x-3 md:flex">
          <li class="flex">
            <a rel="noopener noreferrer" href="#" class="-mb-1 flex items-center border-b-2 px-4">About</a>
          </li>
          <li class="flex">
            <a rel="noopener noreferrer" href="#" class="-mb-1 flex items-center border-b-2 px-4">Blog</a>
          </li>
          <li class="flex">
            <a rel="noopener noreferrer" href="#" class="-mb-1 flex items-center border-b-2 px-4">Projects</a>
          </li>
          <li class="flex">
            <a rel="noopener noreferrer" href="#" class="-mb-1 flex items-center border-b-2 px-4">Contact</a>
          </li>
        </ul>
    ...
    <section>
      <div class="container mx-auto flex flex-col items-center px-4 py-8 text-center md:px-10 lg:px-32 xl:max-w-3xl">
        <h1 class="text-4xl font-bold leading-none sm:text-5xl">Quisquam necessita vel
          <span class="">laborum doloribus</span>delectus
        </h1>
        <p class="mb-12 mt-8 px-8 text-lg">Cupiditate minima voluptate temporibus quia? Architecto beatae esse ab amet
          vero eaque explicabo!</p>
        <div class="flex flex-wrap justify-center">
          <button class="m-2 rounded px-8 py-3 text-lg font-semibold">Get
            started</button>
          <button class="m-2 rounded border px-8 py-3 text-lg">Learn
            more</button>
        </div>
      </div>
    </section>
    <section class="p-6">
      <div class="container mx-auto grid grid-cols-2 justify-center text-center lg:grid-cols-3">
        <div class="m-2 flex flex-col justify-start lg:m-6">
    ...
    <section class="py-8">
      <div class="container mx-auto">
        <div class="mx-auto p-4 text-center md:px-10 lg:px-32 xl:max-w-3xl">
          <h2 class="text-2xl font-bold leading-none sm:text-4xl">What can I offer to you?</h2>
          <p class="my-4 px-8">Graeco causae vim cu, alii option ancillae sea ut. Ad mea alii pertinax, ei sed falli
            ponderum adipisci. Vis iisque scripta cu. Sea ex mollis consulatu dissentiet, dicta viris volutpat mea an,
            et nec discere epicuri</p>
        </div>
        <div class="grid grid-cols-5 p-4 md:p-8">
          <div class="col-span-full flex justify-center px-4 md:col-span-1 md:flex-col md:items-start md:justify-start">
            <button class="border-b-2 p-2 md:border-b-0 md:border-l-2 md:py-3">Mucius</button>
            <button class="border-b-2 px-2 py-1 md:border-b-0 md:border-l-2 md:py-3">Fabellas</button>
            <button class="border-b-2 px-2 py-1 md:border-b-0 md:border-l-2 md:py-3">Aperiam</button>
            <button class="border-b-2 px-2 py-1 md:border-b-0 md:border-l-2 md:py-3">Nonumy</button>
            <button class="border-b-2 px-2 py-1 md:border-b-0 md:border-l-2 md:py-3">Propriae</button>
          </div>
          <div class="col-span-full grid gap-12 py-4 text-center sm:grid-cols-2 md:col-span-4 md:text-left">
            <div class="flex flex-col items-center justify-center space-y-3 md:items-start md:justify-start">
    ...
    <section class="py-6">
      <div
        class="container mx-auto flex flex-col justify-center space-y-8 p-4 md:p-10 lg:flex-row lg:justify-between lg:space-x-12 lg:space-y-0">
        <div class="flex flex-col space-y-4 text-center lg:text-left">
          ...
          <p class="text-lg">Subscribe to my weekly newsletter to find out about the latest and greatest news about
            just about everything!</p>
        </div>
        <div class="flex flex-shrink-0 flex-row items-center justify-center self-center shadow-md lg:justify-end">
          <div class="flex flex-row">
            <input type="text" placeholder="example@email.com" class="w-3/5 rounded-l-lg p-3 sm:w-2/3">
            <button type="button" class="w-2/5 rounded-r-lg p-3 font-semibold sm:w-1/3">Subscribe</button>
          </div>
        </div>
      </div>
    </section>
    <section>
      <div class="container max-w-6xl space-y-6 p-6 sm:space-y-12">
        <a rel="noopener noreferrer" href="#"
          class="group mx-auto block max-w-sm gap-3 hover:no-underline focus:no-underline sm:max-w-full lg:grid lg:grid-cols-12">
          <img src="https://source.unsplash.com/random/480x360" alt="Website Design System"
            class="h-64 w-full rounded object-cover sm:h-96 lg:col-span-7">
          <div class="space-y-2 p-6 lg:col-span-5">
            <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline sm:text-4xl">Noster tincidunt
              reprimique ad pro</h3>
        ...
        <div class="grid grid-cols-1 justify-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <a rel="noopener noreferrer" href="#"
            class="group mx-auto max-w-sm hover:no-underline focus:no-underline">
            <img role="presentation" class="h-44 w-full rounded object-cover"
              src="https://source.unsplash.com/random/480x360?1">
            <div class="space-y-2 p-6">
              <h3 class="text-2xl font-semibold group-hover:underline group-focus:underline">In usu laoreet repudiare
                legendos</h3>
              <span class="text-xs">January 21, 2021</span>
              <p>Mei ex aliquid eleifend forensibus, quo ad dicta apeirian neglegentur, ex has tantas percipit perfecto.
          ...
          <a rel="noopener noreferrer" href="#"
            class="group mx-auto hidden max-w-sm hover:no-underline focus:no-underline sm:block">
            <img role="presentation" class="h-44 w-full rounded object-cover"
        ...
        <div class="flex justify-center">
          <button class="rounded-md px-6 py-3 text-sm hover:underline">Load more
            posts...</button>
        </div>
      </div>
    </section>
                ...
                <div class="rounded p-6 shadow-md">
                  ...
                  <div class="mt-4 flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p class="text-sm">CTO of Company Co.</p>
                    </div>
                  </div>
                </div>
                <div class="rounded p-6 shadow-md">
                  <p>Sit wisi sapientem ut, pri civibus temporibus voluptatibus et, ius cu hinc fabulas. Nam meliore
                    minimum et, regione convenire cum id. Ex pro eros mucius consectetuer, pro magna nulla nonumy ne,
                    eam putent iudicabit consulatu cu.</p>
                  <div class="mt-4 flex items-center space-x-4">
              ...
              <div class="grid content-center gap-4">
                <div class="rounded p-6 shadow-md">
                  <p>Putant omnium elaboraret per ut. Id dicta tritani nominavi quo, mea id justo errem elaboraret. Agam
                    mollis scripserit ea his, ut nec postea verear persecuti. Ea noster senserit eam, ferri omittantur
                    ei nec. Id mel solet libris efficiantur, commune explicari et eos. Case movet ad est, sed tota
                    vocent appetere ea.</p>
                  <div class="mt-4 flex items-center space-x-4">
                ...
                <div class="rounded p-6 shadow-md">
                  <p>Te omnes virtute volutpat sed. Ei esse eros interesset vel, ei populo denique ocurreret vix, eu cum
                    pertinax mandamus vituperatoribus. Solum nihil luptatum per ex, ei amet viderer eos. Ea illum
                    labitur mnesarchum pro. Eius meis salutandi ei nam, alterum expetenda et nec. Expetenda intellegat
                    at eum, per mazim sanctus honestatis ad. Ei noluisse invenire vix. Te ancillae patrioque qui, probo
                    bonorum vivendum ex vim.</p>
                  <div class="mt-4 flex items-center space-x-4">
    ...
    <div
      ...
      <div class="flex flex-col justify-between">
        ...
        <img src="assets/svg/doodle.svg" alt="Contact our customer support" class="h-52 p-6 md:h-64">
      </div>
      <form novalidate="" class="ng-untouched ng-pristine ng-valid space-y-6">
        <div>
          <label for="name" class="text-sm">Full name</label>
          <input id="name" type="text" placeholder="" class="w-full rounded p-3">
        </div>
        <div>
          <label for="email" class="text-sm">Email</label>
          <input id="email" type="email" class="w-full rounded p-3">
        </div>
        <div>
          <label for="message" class="text-sm">Message</label>
          <textarea id="message" rows="3" class="w-full rounded p-3"></textarea>
        </div>
        <button type="submit" class="w-full rounded p-3 text-sm font-bold uppercase tracking-wide">Send
          Message</button>
      </form>
    </div>
    <footer>
      <div class="container mx-auto flex flex-col p-4 md:p-8 lg:flex-row">
        <ul
          class="space-y-4 self-center py-6 text-center sm:flex sm:justify-around sm:space-x-4 sm:space-y-0 lg:flex-1 lg:justify-start">
          <li>About</li>
          <li>Blog</li>
          <li>Projects</li>
          <li>Contact</li>
