    ...
    <body style="background-color: #cccccc; margin: 0; padding: 0; height: 100%;">
        <div style="padding: 40px">
            <div
                ...
                <p style="color: #777777; margin-top: 0;">Du hast eine neue Nachricht erhalten. Hier sind die Details:
                </p>
                ...
                <h5 style="margin-top: 20px; color: #555555; margin-bottom: 10px; font-weight: 500;">Nachricht</h5>
                <p style="color: #777777; margin-top: 5px;">{{ $text }}</p>
            </div>
        </div>
    </body>
