  ...
  <main class="space-y-12">
    ...
    <section class="flex h-full items-center dark:bg-gray-900 dark:text-gray-100 sm:p-16">
      <div class="container mx-auto my-8 flex flex-col items-center justify-center space-y-8 px-5 text-center sm:max-w-md">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-40 w-40 dark:text-gray-600">
        ...
        <p class="text-3xl">
          Es sieht so aus, als ob unsere Dienste momentan offline sind. Bitte versuche es in ein paar Minuten nochmal
        </p>
      </div>
    </section>
  </main>
